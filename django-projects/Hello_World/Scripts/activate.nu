...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'F:\Repos\GitHub\Python-Projects\django-projects\Hello_World'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'F:\Repos\GitHub\Python-Projects\django-projects\Hello_World\Scripts\deactivate.nu'
